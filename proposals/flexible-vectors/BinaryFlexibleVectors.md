...
| `vec.i8.extract_lane_s`  |    `OxFA`|   `0x12`| i:ImmLaneIdxV8           |
...
| `vec.i8.replace_lane`    |    `OxFA`|   `0x13`| i:ImmLaneIdxV8           |
